...
namespace Re_TTSCat.Data
{
    public static class Vars
    {
        ...
        public static readonly string ApiBaiduAi = "https://tsn.baidu.com/text2audio?tex=$TTSTEXT&lan=zh&per=$PERSON&spd=$SPEED&cuid=1234567JAVA&ctp=1&tok=$TOKEN";
        ...
        public static readonly Version CurrentVersion = new Version("3.8.67.545");
